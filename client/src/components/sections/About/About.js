                ...
                <div className={classes.about}>
                    <div className={classes["about__descriptions"]}>
                        <p className={classes["description-txt"]}>
                            ...
                            quibusdam, molestiae earum pariatur sequi facilis aliquid voluptatibus
                            molestias, necessitatibus temporibus natus adipisci porro accusamus
                            vitae corporis neque culpa? Error, asperiores?
                        </p>
                        <p className={classes["description-txt"]}>
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Officiis harum
                            quasi obcaecati exercitationem ipsam reprehenderit esse quas, ipsum
                            nobis culpa adipisci odit labore et quae a facilis sunt repellat.
                            Tempora eum totam facere dolorem molestias.
                        </p>
                    </div>
                </div>
